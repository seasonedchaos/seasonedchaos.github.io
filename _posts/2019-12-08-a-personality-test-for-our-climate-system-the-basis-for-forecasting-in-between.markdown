...
<br><sub><sup><i>Forecast skill as it relates to how far out one is trying to forecast; subseasonal prediction is the blue curve beneath the bridge</i></sub></sup>
<br>
